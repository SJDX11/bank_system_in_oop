...
public:
	...
	static string CurrentTime()
	{
		...
		string day, houre, monthe, year, secound, minet;
		day = to_string(localTime->tm_mday);
		monthe = to_string(localTime->tm_mon+1) ;
		year = to_string(localTime->tm_year+1900) ;
		secound = to_string (localTime->tm_sec);
		minet = to_string(localTime->tm_min) ;
		houre =to_string(localTime->tm_hour) ;
